package io.unicid.registry.jms;
...
@ApplicationScoped
public class MtConsumer extends AbstractConsumer<BaseMessage> {
	...
	@ConfigProperty(name = "io.unicid.jms.ex.delay")
	Long _exDelay;
	
	
	@ConfigProperty(name = "io.unicid.jms.mt.queue.name")
	String _queueName;
	
	@ConfigProperty(name = "io.unicid.jms.mt.consumer.threads")
	Integer _threads;
