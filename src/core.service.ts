        ...
        case StateStep.MRZ:
          if (content instanceof MrzDataSubmitMessage) {
            if (content.state === MrtdSubmitState.Submitted) {
              await this.sendText(session.connectionId, 'MRZ_SUCCESSFUL', session.lang) // TODO: When MRZ is valid add to the message "Congratulations, your document is compatible with UnicID."
